...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sharon Varghese — Software Engineer & AWS Cloud Enthusiast" },
      { name: "description", content: "Portfolio of Sharon Varghese, MCA student and aspiring software engineer specializing in web development and AWS cloud." },
      { property: "og:title", content: "Sharon Varghese — Software Engineer & AWS Cloud Enthusiast" },
